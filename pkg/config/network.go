	...
	list := []NetworkConfig{
		...
		},
		{
			...
			FundedAccounts: []FundedAccount{
				...
				{
					PublicKey: types.Secp256k1PublicKey{0x2, 0x2f, 0xae, 0x96, 0x14, 0xe, 0x4e, 0x4e, 0xfc, 0x42, 0xaa, 0xce, 0xc2, 0xbf, 0x72, 0x49, 0xd6, 0x50, 0xf8, 0xde, 0x85, 0xe4, 0xfc, 0xe4, 0x45, 0x4e, 0xcb, 0xb1, 0x85, 0xc0, 0xdb, 0x81, 0xa5},
					Balances:  "10000000000000" + TokenSymbolDev,
				},

				// Staker of validator 1
				{
					PublicKey: types.Secp256k1PublicKey{0x2, 0x64, 0xfd, 0xa6, 0x29, 0xc4, 0x89, 0x7b, 0xcf, 0x9b, 0xa6, 0x1f, 0xd9, 0xbe, 0xae, 0x61, 0x20, 0x49, 0xfd, 0x93, 0xb6, 0x3, 0xa5, 0xab, 0xe8, 0xdf, 0x6, 0xe0, 0xcf, 0x61, 0xd1, 0x8d, 0xa7},
					Balances:  "10000000000000" + TokenSymbolDev,
				},

				// Staker of validator 2
				{
					PublicKey: types.Secp256k1PublicKey{0x2, 0x68, 0x60, 0xc0, 0xa3, 0xcf, 0x14, 0x8c, 0xb, 0xdd, 0xd5, 0xe0, 0xbf, 0xf1, 0xb5, 0x3d, 0xd7, 0xee, 0x0, 0xf9, 0xab, 0x61, 0xd9, 0xa5, 0x82, 0x6f, 0x56, 0x21, 0x7, 0x50, 0x60, 0xd8, 0xd0},
					Balances:  "10000000000000" + TokenSymbolDev,
				},

				// Staker of validator 3
				{
					PublicKey: types.Secp256k1PublicKey{0x3, 0x93, 0xa9, 0x5b, 0xd4, 0x80, 0xa9, 0x1c, 0x6, 0xe6, 0x5d, 0xc7, 0xdd, 0x9c, 0xa4, 0xf6, 0x97, 0xfc, 0xd, 0x6b, 0x83, 0xb1, 0x37, 0x1c, 0xf9, 0x75, 0x68, 0xd3, 0x3c, 0x24, 0x85, 0xe6, 0x94},
					Balances:  "10000000000000" + TokenSymbolDev,
				},

				// Faucet's account storing the rest of total supply
				{
					PublicKey: types.Secp256k1PublicKey{0x2, 0x5b, 0xb9, 0x1c, 0x57, 0xec, 0x12, 0x10, 0x92, 0x58, 0xef, 0xf9, 0x5, 0x7b, 0x70, 0x9d, 0x96, 0xbb, 0x57, 0xc5, 0xaa, 0x38, 0x61, 0x60, 0xca, 0xb2, 0x9, 0x21, 0xf, 0x45, 0x32, 0xc6, 0x6b},
					Balances:  "10000000000000" + TokenSymbolDev,
				},
			},
