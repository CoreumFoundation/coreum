...
// Predefined chains constants
const (
	ChainIDMain       ChainID = "coreum-mainnet-1"
	AddressPrefixMain string  = "core"
	DenomMain         string  = "core"
	// BaseDenomMain uses the u (μ) prefix stands for micro, more info here https://en.wikipedia.org/wiki/Metric_prefix
	...
	BaseDenomMain string = "ucore"

	ChainIDDev       ChainID = "coreum-devnet-1"
	AddressPrefixDev string  = "devcore"
	DenomDev         string  = "dcore"
	BaseDenomDev     string  = "ducore"
)
	...
	list := []NetworkConfig{
		{
			...
			AddressPrefix: AddressPrefixMain,
			Denom:         DenomMain,
			BaseDenom:     BaseDenomMain,
			Fee:           feeConfig,
			GovConfig:     govConfig,
			StakingConfig: stakingConfig,
		},
