...
func TestAutoGasPrices(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			feeAssertion: func(t *testing.T, fee sdk.Coins) {
				require.True(t, fee.IsEqual(sdk.NewCoins(sdk.NewCoin("ducore", sdk.NewInt(10000)))))
			},
		},
		{
			name:  "specific gas prices are provided",
		...
		},
		{
			...
			feeAssertion: func(t *testing.T, fee sdk.Coins) {
				require.True(t, fee.IsEqual(sdk.NewCoins(sdk.NewCoin("ducore", sdk.NewInt(12345)))))
			},
		},
		{
