...
type AppModule struct {
	nftmodule.AppModule
	keeper keeper.NFTKeeperWrapper
}

// NewAppModule creates a new wnft AppModule object.
func NewAppModule(cdc codec.Codec, keeper keeper.NFTKeeperWrapper, ak nft.AccountKeeper, bk nft.BankKeeper, registry codectypes.InterfaceRegistry) AppModule {
