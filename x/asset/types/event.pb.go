...
type EventFungibleTokenFreezeAmountChanged struct {
...
func (m *EventFungibleTokenFreezeAmountChanged) Reset()         { *m = EventFungibleTokenFreezeAmountChanged{} }
func (m *EventFungibleTokenFreezeAmountChanged) String() string { return proto.CompactTextString(m) }
func (*EventFungibleTokenFreezeAmountChanged) ProtoMessage()    {}
func (*EventFungibleTokenFreezeAmountChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_aede4b64fdc52aa3, []int{1}
}
func (m *EventFungibleTokenFreezeAmountChanged) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventFungibleTokenFreezeAmountChanged) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventFungibleTokenFreezeAmountChanged.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventFungibleTokenFreezeAmountChanged) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventFungibleTokenFreezeAmountChanged.Merge(m, src)
}
func (m *EventFungibleTokenFreezeAmountChanged) XXX_Size() int {
	return m.Size()
}
func (m *EventFungibleTokenFreezeAmountChanged) XXX_DiscardUnknown() {
	xxx_messageInfo_EventFungibleTokenFreezeAmountChanged.DiscardUnknown(m)
}

var xxx_messageInfo_EventFungibleTokenFreezeAmountChanged proto.InternalMessageInfo

func (m *EventFungibleTokenFreezeAmountChanged) GetAccount() string {
	if m != nil {
		return m.Account
	}
	return ""
...
func (m *EventFungibleTokenFreezeAmountChanged) GetPreviousAmount() types.Coin {
	if m != nil {
...
func (m *EventFungibleTokenFreezeAmountChanged) GetCurrentAmount() types.Coin {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*EventFungibleTokenFreezeAmountChanged)(nil), "coreum.asset.v1.EventFungibleTokenFreezeAmountChanged")
}
...
var fileDescriptor_aede4b64fdc52aa3 = []byte{
	...
	,
}
...
func (m *EventFungibleTokenFreezeAmountChanged) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventFungibleTokenFreezeAmountChanged) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventFungibleTokenFreezeAmountChanged) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventFungibleTokenFreezeAmountChanged) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventFungibleTokenFreezeAmountChanged) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventFungibleTokenFreezeAmountChanged: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventFungibleTokenFreezeAmountChanged: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
