...
type EventIssued struct {
	...
	DEXRestrictions    *DEXRestrictions            `protobuf:"bytes,15,opt,name=dex_restrictions,json=dexRestrictions,proto3" json:"dex_restrictions,omitempty"`
}
...
func (m *EventIssued) GetDEXRestrictions() *DEXRestrictions {
	if m != nil {
...
type EventDEXRestrictionsChanged struct {
	PreviousRestrictions *DEXRestrictions `protobuf:"bytes,1,opt,name=previous_restrictions,json=previousRestrictions,proto3" json:"previous_restrictions,omitempty"`
	NewRestrictions      DEXRestrictions  `protobuf:"bytes,2,opt,name=new_restrictions,json=newRestrictions,proto3" json:"new_restrictions"`
}

func (m *EventDEXRestrictionsChanged) Reset()         { *m = EventDEXRestrictionsChanged{} }
func (m *EventDEXRestrictionsChanged) String() string { return proto.CompactTextString(m) }
func (*EventDEXRestrictionsChanged) ProtoMessage()    {}
func (*EventDEXRestrictionsChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_bdf87682d70b967f, []int{8}
}
func (m *EventDEXRestrictionsChanged) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventDEXRestrictionsChanged) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventDEXRestrictionsChanged.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventDEXRestrictionsChanged) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventDEXRestrictionsChanged.Merge(m, src)
}
func (m *EventDEXRestrictionsChanged) XXX_Size() int {
	return m.Size()
}
func (m *EventDEXRestrictionsChanged) XXX_DiscardUnknown() {
	xxx_messageInfo_EventDEXRestrictionsChanged.DiscardUnknown(m)
}

var xxx_messageInfo_EventDEXRestrictionsChanged proto.InternalMessageInfo

func (m *EventDEXRestrictionsChanged) GetPreviousRestrictions() *DEXRestrictions {
	if m != nil {
		return m.PreviousRestrictions
	}
	return nil
}

func (m *EventDEXRestrictionsChanged) GetNewRestrictions() DEXRestrictions {
	if m != nil {
		return m.NewRestrictions
	}
...
func init() {
	...
	proto.RegisterType((*EventDEXRestrictionsChanged)(nil), "coreum.asset.ft.v1.EventDEXRestrictionsChanged")
}
...
var fileDescriptor_bdf87682d70b967f = []byte{
	...
	,
}
...
func (m *EventDEXRestrictionsChanged) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventDEXRestrictionsChanged) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventDEXRestrictionsChanged) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.NewRestrictions.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x12
	if m.PreviousRestrictions != nil {
		{
			size, err := m.PreviousRestrictions.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EventDEXRestrictionsChanged) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.PreviousRestrictions != nil {
		l = m.PreviousRestrictions.Size()
		n += 1 + l + sovEvent(uint64(l))
	}
	l = m.NewRestrictions.Size()
	n += 1 + l + sovEvent(uint64(l))
	return n
}
...
func (m *EventDEXRestrictionsChanged) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventDEXRestrictionsChanged: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventDEXRestrictionsChanged: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreviousRestrictions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PreviousRestrictions == nil {
				m.PreviousRestrictions = &DEXRestrictions{}
			}
			if err := m.PreviousRestrictions.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewRestrictions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NewRestrictions.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
