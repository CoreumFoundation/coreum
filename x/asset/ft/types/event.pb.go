...
type EventLockedAmountChanged struct {
	Account        string                                 `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
	Denom          string                                 `protobuf:"bytes,2,opt,name=denom,proto3" json:"denom,omitempty"`
	PreviousAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=previous_amount,json=previousAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"previous_amount"`
	CurrentAmount  github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=current_amount,json=currentAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"current_amount"`
...
func (m *EventLockedAmountChanged) Reset()         { *m = EventLockedAmountChanged{} }
func (m *EventLockedAmountChanged) String() string { return proto.CompactTextString(m) }
func (*EventLockedAmountChanged) ProtoMessage()    {}
func (*EventLockedAmountChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_bdf87682d70b967f, []int{4}
}
func (m *EventLockedAmountChanged) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventLockedAmountChanged) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventLockedAmountChanged.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventLockedAmountChanged) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventLockedAmountChanged.Merge(m, src)
}
func (m *EventLockedAmountChanged) XXX_Size() int {
	return m.Size()
}
func (m *EventLockedAmountChanged) XXX_DiscardUnknown() {
	xxx_messageInfo_EventLockedAmountChanged.DiscardUnknown(m)
}

var xxx_messageInfo_EventLockedAmountChanged proto.InternalMessageInfo

func (m *EventLockedAmountChanged) GetAccount() string {
	if m != nil {
		return m.Account
	}
	return ""
...
func (m *EventLockedAmountChanged) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*EventLockedAmountChanged)(nil), "coreum.asset.ft.v1.EventLockedAmountChanged")
...
var fileDescriptor_bdf87682d70b967f = []byte{
	...
	,
}
...
func (m *EventLockedAmountChanged) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventLockedAmountChanged) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventLockedAmountChanged) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventLockedAmountChanged) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventLockedAmountChanged) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventLockedAmountChanged: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventLockedAmountChanged: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
