...
type EventAdminTransfered struct {
	Denom         string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
...
func (m *EventAdminTransfered) Reset()         { *m = EventAdminTransfered{} }
func (m *EventAdminTransfered) String() string { return proto.CompactTextString(m) }
func (*EventAdminTransfered) ProtoMessage()    {}
func (*EventAdminTransfered) Descriptor() ([]byte, []int) {
	return fileDescriptor_bdf87682d70b967f, []int{3}
}
func (m *EventAdminTransfered) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventAdminTransfered) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventAdminTransfered.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventAdminTransfered) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventAdminTransfered.Merge(m, src)
}
func (m *EventAdminTransfered) XXX_Size() int {
	return m.Size()
}
func (m *EventAdminTransfered) XXX_DiscardUnknown() {
	xxx_messageInfo_EventAdminTransfered.DiscardUnknown(m)
}

var xxx_messageInfo_EventAdminTransfered proto.InternalMessageInfo

func (m *EventAdminTransfered) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *EventAdminTransfered) GetPreviousAdmin() string {
	if m != nil {
...
func (m *EventAdminTransfered) GetCurrentAdmin() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*EventAdminTransfered)(nil), "coreum.asset.ft.v1.EventAdminTransfered")
}
...
var fileDescriptor_bdf87682d70b967f = []byte{
	...
	,
}
...
func (m *EventAdminTransfered) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventAdminTransfered) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventAdminTransfered) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventAdminTransfered) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventAdminTransfered) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventAdminTransfered: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventAdminTransfered: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
