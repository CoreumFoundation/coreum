...
type ExtensionIssueSettings struct {
	...
	InstantiationInfo github_com_CosmWasm_wasmd_x_wasm_types.RawContractMessage `protobuf:"bytes,4,opt,name=instantiationInfo,proto3,casttype=github.com/CosmWasm/wasmd/x/wasm/types.RawContractMessage" json:"instantiationInfo,omitempty"`
}
...
var fileDescriptor_e54b0962ccfc4ca0 = []byte{
	...
	,
}
...
func (m *ExtensionIssueSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.InstantiationInfo) > 0 {
		i -= len(m.InstantiationInfo)
		copy(dAtA[i:], m.InstantiationInfo)
		i = encodeVarintTx(dAtA, i, uint64(len(m.InstantiationInfo)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Funds) > 0 {
...
func (m *ExtensionIssueSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstantiationInfo", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InstantiationInfo = append(m.InstantiationInfo[:0], dAtA[iNdEx:postIndex]...)
			if m.InstantiationInfo == nil {
				m.InstantiationInfo = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
