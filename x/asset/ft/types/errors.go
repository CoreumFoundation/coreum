...
var (
	...
	// ErrDEXRestrictionsNotFound error for a DEX restrictions not found in the store.
	ErrDEXRestrictionsNotFound = sdkerrors.Register(ModuleName, 11, "DEX restrictions not found")
)
