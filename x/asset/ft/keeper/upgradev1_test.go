...
func TestUpgradeV1(t *testing.T) {
	...
	requireT.Error(ftKeeper.StoreDelayedUpgradeV1(ctxSDK, issuer1, "denom", false))

	// call from non-issuer account fails
	requireT.Error(ftKeeper.StoreDelayedUpgradeV1(ctxSDK, issuer1, denom2, false))

	// first call succeeds
	requireT.NoError(ftKeeper.StoreDelayedUpgradeV1(ctxSDK, issuer1, denom1, false))
	...
	requireT.NoError(ftKeeper.StoreDelayedUpgradeV1(ctxSDK, issuer2, denom2, true))
	...
	requireT.Error(ftKeeper.StoreDelayedUpgradeV1(ctxSDK, issuer2, denom2, false))
