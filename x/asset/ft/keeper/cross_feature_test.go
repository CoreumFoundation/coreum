...
//
// $ Non-issuer + Whitelist (add this test directly to whitelisting)
// - whitelist non-issuer to have 10 coins, send 10 coins to non-issuer, try to set non-issuer whitelist amount to 9, the tx should pass
//
// # All in one
