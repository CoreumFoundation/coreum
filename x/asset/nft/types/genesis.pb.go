...
type GenesisState struct {
	...
	Whitelisted      []Whitelisted     `protobuf:"bytes,4,rep,name=whitelisted,proto3" json:"whitelisted"`
}
...
func (m *GenesisState) GetWhitelisted() []Whitelisted {
	if m != nil {
...
func (m *Whitelisted) Reset()         { *m = Whitelisted{} }
func (m *Whitelisted) String() string { return proto.CompactTextString(m) }
func (*Whitelisted) ProtoMessage()    {}
func (*Whitelisted) Descriptor() ([]byte, []int) {
	return fileDescriptor_3abcf08d60f6fbfd, []int{2}
}
func (m *Whitelisted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Whitelisted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Whitelisted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Whitelisted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Whitelisted.Merge(m, src)
}
func (m *Whitelisted) XXX_Size() int {
	return m.Size()
}
func (m *Whitelisted) XXX_DiscardUnknown() {
	xxx_messageInfo_Whitelisted.DiscardUnknown(m)
}

var xxx_messageInfo_Whitelisted proto.InternalMessageInfo

func (m *Whitelisted) GetClassID() string {
	if m != nil {
		return m.ClassID
	}
	return ""
...
func (m *Whitelisted) GetNftID() string {
	if m != nil {
		return m.NftID
	}
	return ""
...
func (m *Whitelisted) GetAccounts() []string {
	if m != nil {
		return m.Accounts
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Whitelisted)(nil), "coreum.asset.nft.v1.Whitelisted")
}
...
var fileDescriptor_3abcf08d60f6fbfd = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Whitelisted) > 0 {
		for iNdEx := len(m.Whitelisted) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Whitelisted[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Whitelisted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Whitelisted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Whitelisted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Whitelisted = append(m.Whitelisted, Whitelisted{})
			if err := m.Whitelisted[len(m.Whitelisted)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Whitelisted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Whitelisted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Whitelisted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
