...
// ListBurnt return the list of burnt NFTs in class.
func (k Keeper) ListBurnt(ctx sdk.Context, classID string, q *query.PageRequest) (*query.PageResponse, []string, error) {
