...
func (suite *SimTestSuite) TestWeightedOperations() {
	weightedOps := simulation.WeightedOperations(
		...
		suite.app.BankKeeper, suite.app.WNFTKeeper.Keeper,
	)
...
func (suite *SimTestSuite) TestSimulateMsgSend() {
	...
	op := simulation.SimulateMsgSend(codec.NewProtoCodec(registry), suite.app.AccountKeeper, suite.app.BankKeeper, suite.app.WNFTKeeper.Keeper)
