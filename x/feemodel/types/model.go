...
func (m *Model) ParamSetPairs() paramtypes.ParamSetPairs {
	nilValidator := func(value interface{}) error {
		return nil
	}

	return paramtypes.ParamSetPairs{
		paramtypes.NewParamSetPair([]byte("InitialGasPrice"), &m.InitialGasPrice, nilValidator),
		paramtypes.NewParamSetPair([]byte("MaxGasPrice"), &m.MaxGasPrice, nilValidator),
		paramtypes.NewParamSetPair([]byte("MaxDiscount"), &m.MaxDiscount, nilValidator),
		paramtypes.NewParamSetPair([]byte("EscalationStartBlockGas"), &m.EscalationStartBlockGas, nilValidator),
		paramtypes.NewParamSetPair([]byte("MaxBlockGas"), &m.MaxBlockGas, nilValidator),
		paramtypes.NewParamSetPair([]byte("ShortAverageBlockLength"), &m.ShortAverageBlockLength, nilValidator),
		paramtypes.NewParamSetPair([]byte("LongAverageBlockLength"), &m.LongAverageBlockLength, nilValidator),
	}
}
