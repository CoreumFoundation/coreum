...
func New(
	...
	// Since 0.47 we all clients must register themselves and are not registered automatically.
	// we need to register localhost client since we use it in integration tests.
