...
func New(
	...
	app.WNFTKeeper = wnftkeeper.NewWrappedNFTKeeper(nftKeeper, app.AssetNFTKeeper)
	...
	wnftModule := wnft.NewAppModule(appCodec, app.WNFTKeeper, app.AccountKeeper, app.BankKeeper, app.interfaceRegistry)
