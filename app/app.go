...
import (
	...
	"github.com/CoreumFoundation/coreum/x/bank"
	bankkeeper "github.com/CoreumFoundation/coreum/x/bank/keeper"
...
//
//nolint:funlen,gofmt,goimports // Disable linting for code generated by Cosmos SDK, gofmt and goimports are crazy about this place without reason
func New(
	logger log.Logger,
	db dbm.DB,
	...
	app.BankKeeper = bankkeeper.NewBaseKeeper(
		appCodec, keys[banktypes.StoreKey], app.AccountKeeper, app.GetSubspace(banktypes.ModuleName), app.ModuleAccountAddrs(), app.FreezeKeeper,
	)
