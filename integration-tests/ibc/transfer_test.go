...
func TestIBCTransferFromCoreumToGaiaAndBack(t *testing.T) {
	...
	// TODO: (Same comments apply to TestIBCTransferFromGaiaToCoreumAndBack.)
	//  1. here it should be coreumToGaiaChannelID := coreumChain.GetIBCChannelID
	//  2. In crust we should come up with another naming convention for channels
