...
func TestWithdrawRewardWithDeterministicGas(ctx context.Context, t testing.T, chain testing.Chain) { //nolint:funlen // this test covers the full withdrawal scenario
