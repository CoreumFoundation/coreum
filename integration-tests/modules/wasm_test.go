...
func TestWASMPinningAndUnpinningSmartContractUsingGovernance(t *testing.T) {
	...
	chain.Faucet.FundAccounts(ctx, t,
		znet.NewFundedAccount(admin, chain.NewCoin(sdkmath.NewInt(5000000000))),
		znet.NewFundedAccount(proposer, proposerBalance),
	)
...
func TestWASMContractUpgrade(t *testing.T) {
	...
	chain.Faucet.FundAccounts(ctx, t,
		znet.NewFundedAccount(admin, chain.NewCoin(sdkmath.NewInt(5000000))),
		znet.NewFundedAccount(noneAdmin, chain.NewCoin(sdkmath.NewInt(5000000))),
	)
...
func TestUpdateAndClearAdminOfContract(t *testing.T) {
	...
	chain.FundAccountWithOptions(ctx, t, newAdmin, znet.BalancesOptions{
		Messages: []sdk.Msg{
...
func TestWASMAuthzContract(t *testing.T) {
	...
	chain.Faucet.FundAccounts(ctx, t,
		znet.NewFundedAccount(granter, chain.NewCoin(sdkmath.NewInt(5000000000))),
	)
...
func TestWASMBankSendContractWithMultipleFundsAttached(t *testing.T) {
	...
	requireT := require.New(t)
	chain.Faucet.FundAccounts(ctx, t,
		znet.NewFundedAccount(admin, chain.NewCoin(sdk.NewInt(5000_000_000))),
	)
