...
func Tests() []testing.TestSet {
	return []testing.TestSet{
		...
		},
		{
			...
			Parallel: true,
			SingleChain: []testing.SingleChainSignature{
				assetft.TestIssueBasicFungibleToken,
				assetft.TestFreezeFungibleToken,
				assetft.TestFreezeUnfreezableFungibleToken,
				assetft.TestGloballyFreezeFungibleToken,
				assetft.TestWhitelistUnwhitelistableFungibleToken,
				assetft.TestWhitelistFungibleToken,
				assetft.TestMintFungibleToken,
				assetft.TestBurnFungibleToken,
				assetft.TestBurnRateFungibleToken,
				assetnft.TestIssueNonFungibleTokenClass,
				assetnft.TestMintNonFungibleToken,
