...
var configBreakingTmpl string //nolint:unused // unused temporary

func breakingProto(ctx context.Context, deps types.DepsFunc) error { //nolint:unused,deadcode // unused temporary
