...
func VerifyInitialBalance(chain cored.Cored) (testing.PrepareFunc, testing.RunFunc) {
...
func TransferCore(chain cored.Cored) (testing.PrepareFunc, testing.RunFunc) {
